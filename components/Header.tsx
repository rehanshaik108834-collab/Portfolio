...
const socialItems: SocialItem[] = [
  { label: "GitHub", href: "https://github.com/rehanshaik108834-collab" },
  { label: "LinkedIn", href: "https://www.linkedin.com/in/rehan-shaik-980b2b360/" },
  { label: "Email", href: "mailto:rehanshaik3106@gmail.com" },
];
...
const Header = () => {
  ...
  return (
    <>
      {/* Top-left Name */}
      <div className="fixed top-6 left-6 md:top-8 md:left-10 z-[210] pointer-events-none">
        <span className="block text-lg md:text-2xl font-black uppercase tracking-[0.25em] font-sans text-white">
          REHAN SHAIK
        </span>
      </div>
